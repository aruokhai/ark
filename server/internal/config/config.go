...
func LoadConfig() (*Config, error) {
	...
	return &Config{
		...
		Network:                 net,
		RoundLifetime:           common.FromConfig(viper.GetInt64(RoundLifetime)),
		UnilateralExitDelay:     common.FromConfig(viper.GetInt64(UnilateralExitDelay)),
		BoardingExitDelay:       common.FromConfig(viper.GetInt64(BoardingExitDelay)),
